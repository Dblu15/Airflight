...
<!-- Mirrored from jetly-html.vercel.app/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 18:04:33 GMT -->
...
<div class="page-wrapper">
                        ...
                        <ul class="main-menu__list">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="shadow-box">
                                    ...
                                    <li><a href="destination-details.html">Destination</a></li>
                                    <li><a href="testimonials-carousel.html">Testimonials</a></li>
    ...
    <section class="feature-one">
        <div class="feature-one__shape-1 float-bob-y-2">
            ...
            <div class="feature-one__shadow">
                <img src="{{asset('assets/images/shapes/feature-one-shadow.png')}}" alt="">
            </div>
        </div>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                        ...
                        <div class="feature-two__content-box">
                            <div class="feature-two__content-box-inner">
                                <div class="feature-two__shape-1">
                                    <img src="{{asset('assets/images/shapes/feature-two-shape-1.png')}}" alt="">
                                </div>
                                <div class="feature-two__dot">
                                    <img src="{{asset('assets/images/shapes/feature-two-dot.png')}}" alt="">
                                </div>
                    ...
                    <div class="feature-two__single">
                        <div class="feature-two__img-box">
                            <div class="feature-two__img">
                                <img src="{{asset('assets/images/resources/feature-two-1-2.jpg')}}" alt="">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                    <div class="feature-two__single">
                        <div class="feature-two__img-box">
                            <div class="feature-two__img">
                                <img src="{{asset('assets/images/resources/feature-two-1-3.jpg')}}" alt="">
                                <div class="feature-two__tilte-box">
    ...
    <section class="get-flight">
        <div class="get-flight-img">
            <img src="{{asset('assets/images/resources/get-flight-img-1.png')}}" alt="">
        </div>
        <div class="get-flight__shape-1 float-bob-x">
            <img src="{{asset('assets/images/shapes/get-flight-shape-1.png')}}" alt="">
        </div>
        <div class="get-flight__shape-2 float-bob-x">
            <img src="{{asset('assets/images/shapes/get-flight-shape-2.png')}}" alt="">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-xl-8">
    ...
    <section class="testimonial-one">
        <div class="testimonial-one__shape-1 zoom-fade-2">
            <img src="{{asset('assets/images/shapes/testimonial-shape-1.png')}}" alt="">
        </div>
        <div class="testimonial-one__shape-2 float-bob-x">
            <img src="{{asset('assets/images/shapes/testimonial-shape-2.png')}}" alt="">
        </div>
        <div class="testimonial-one__shape-3 float-bob-x">
            <img src="{{asset('assets/images/shapes/testimonial-shape-3.png')}}" alt="">
        </div>
        <div class="container">
            <div class="section-title text-center">
            ...
            <div class="testimonial-one__bottom">
                <div class="testimonial-one__shape-4"
                     style="background-image: url({{asset('assets/images/shapes/testimonial-shape-4.png')}});"></div>
        ...
        <div class="special-offer-one__wrap">
            <div class="special-offer-one__left">
                <div class="special-offer-one__shape-1"
                     style="background-image: url({{asset('assets/images/shapes/special-offer-one-shape-1.png')}});"></div>
                <div class="special-offer-one__shape-2 float-bob-x">
                    <img src="{{asset('assets/images/shapes/special-offer-one-shape-2.png')}}" alt="">
                </div>
            ...
            <div class="special-offer-one__right">
                <div class="special-offer-one__bg"
                     style="background-image: url({{asset('assets/images/backgrounds/special-offer-one-bg.jpg')}});"></div>
                                ...
                                <div class="price-one__single">
                                    ...
                                    <div class="price-one__content">
                                        <div class="price-one__img">
                                            <img src="{{asset('assets/images/resources/price-one-1-1.png')}}" alt="">
                                        </div>
    ...
    <section class="destination-one">
        <div class="destination-one__shape-1"
             style="background-image: url({{asset('assets/images/shapes/destination-one-shape-1.png')}});"></div>
        <div class="container">
            <div class="section-title text-center">
            ...
            <div class="row">
                    ...
                    <div class="destination-one__single">
                        <div class="destination-one__img-box">
                            <div class="destination-one__img">
                                <img src="{{asset('assets/images/resources/destination-1-1.jpg')}}" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                    <div class="destination-one__single">
                        <div class="destination-one__img-box">
                            <div class="destination-one__img">
                                <img src="{{asset('assets/images/resources/destination-1-2.jpg')}}" alt="">
                            </div>
                            <div class="destination-one__content">
                ...
                <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                    <div class="destination-one__single">
                        <div class="destination-one__img-box">
                            <div class="destination-one__img">
                                <img src="{{asset('assets/images/resources/destination-1-3.jpg')}}" alt="">
                            </div>
                            <div class="destination-one__content">
    ...
    <section class="newsletter">
        <div class="newsletter__shape-1 float-bob-y">
            <img src="{{asset('assets/images/shapes/newsletter-shape-1.png')}}" alt="">
        </div>
        <div class="newsletter__shape-2 float-bob-x">
            <img src="{{asset('assets/images/shapes/newsletter-shape-2.png')}}" alt="">
        </div>
        <div class="container">
            <div class="row">
                            ...
                            <div class="footer-widget__column footer-widget__Contact">
                                ...
                                <ul class="footer-widget__Contact-list list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p><a href="mailto:ductvph20997@fpt.edu.vn">ductvph20997@fpt.edu.vn</a></p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                        ...
                                        <div class="text">
                                            <p>Phương Canh, Xuân Phương, Hà Nội</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
<div class="mobile-nav__wrapper">
    ...
    <div class="mobile-nav__content">
        ...
        <div class="logo-box">
            <a href="index.html" aria-label="logo image"><img src="{{asset('assets/images/resources/logo-1.png" width="143"
                                                              alt="')}}" /></a>
        </div>
        <!-- /.logo-box -->
        ...
        <ul class="mobile-nav__contact list-unstyled">
            <li>
                ...
                <a href="mailto:ductvph20997@fpt.edu.vn">ductvph20997@fpt.edu.vn</a>
            </li>
            <li>
...
<!-- template js -->
<script src="{{asset('assets/js/jetly.js')}}"></script>
</body>


<!-- Mirrored from jetly-html.vercel.app/main-html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2023 18:05:10 GMT -->
</html>
